...
RSpec.describe Order do
  ...
  describe 'instance methods' do
    before :each do
      ...
      @test_item = @megan.items.create!(name: 'Test Item', description: "Item for test", price: 10, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaLM_vbg2Rh-mZ-B4t-RSU9AmSfEEq_SN9xPP_qrA2I6Ftq_D9Qw', active: true, inventory: 10 )
      ...
      @discount_1 = @megan.discounts.create!(name: "Test_1 Discount", description: "Great bulk discount", min_quantity: 5, percent: 50)
      @order_3 = @user.orders.create!(status: "pending")
      @order_item_4 = @order_3.order_items.create!(item: @test_item, price: @test_item.price, quantity: 5, fulfilled: true)
  ...
  describe 'class methods' do
    ...
    it "has discount applied upon checkout" do
      expect(@order_2.disc_total(50, 25)).to eq(true)
    end
  end
end
